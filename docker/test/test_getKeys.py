...
warning = 85
expiration = 90
sample = 87 # should be more than warning, less than expiration
...
def test_issue_users_dict():
  ...
  #return dict with list of warning keys + days remaining and a list of keys to expire
  ...
  users = getKeys.getIssueUsers(warning, expiration)
  ...
  assert users[2]['expire'][0] == test3KeysResponse['AccessKeyMetadata'][1]['AccessKeyId']